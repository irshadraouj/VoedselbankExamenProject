...
<div id="save_settings">
    <?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module='.WYVERN_MAP.AMP.'method=settings')?>
    ...
    foreach ($settings as $label => $v)
    {
        ...
        $this->table->set_heading(
            array('data' => lang(WYVERN_MAP.'_'.$label), 'style' => 'width:25%;'),
            lang(WYVERN_MAP.'_setting')
        );
